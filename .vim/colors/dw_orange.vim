...
hi Identifier      gui=none       guibg=#000000  guifg=#d13800
...
hi Operator        gui=bold                      guifg=#696969
hi PreProc         gui=bold                      guifg=#ffffff
hi Question                                      guifg=#ffff00
hi Search          gui=none       guibg=#ff4400  guifg=#000000
hi Pmenu           gui=bold       guibg=#ffff00  guifg=#000000
hi PmenuSel        gui=bold       guibg=#111111  guifg=#ff9900
hi SignColumn                     guibg=#111111  guifg=#ffffff
hi Special         gui=bold       guibg=#000000  guifg=#ffa600
...
hi Title           gui=bold                      guifg=#ffffff
hi Todo            gui=bold       guibg=#000000  guifg=#ff0000
hi Type            gui=bold                      guifg=#ffffff
hi VertSplit       gui=none       guibg=#cccccc  guifg=#777777
